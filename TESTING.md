...
- **Test**:
  - [ ] Open https://a6cars-frontend-zv4g.onrender.com/book.html (not logged in)
...
```bash
curl https://a6cars-backend-ylx7.onrender.com/api/bookings/1
# Expected: Array of {start_date, end_date} for car_id=1
```
  - [ ] Wait 1 second for polling
  - [ ] Verify: Auto-redirects to Collection QR
```bash
curl -X POST https://a6cars-backend-ylx7.onrender.com/api/book \
...
```bash
curl https://a6cars-backend-ylx7.onrender.com/api/payment/status/1
# Expected: {paid: true/false, status: "pending"/"confirmed"}
```
    - Booking: dates, amount, status
    - Car: model, location
```bash
curl -X POST https://a6cars-backend-ylx7.onrender.com/api/payment/confirm \
  -H "Content-Type: application/json" \
  -d '{"booking_id": 1}'
...
- **Test**:
```bash
curl -X POST https://a6cars-backend-ylx7.onrender.com/api/admin/verify-qr \
  -H "Content-Type: application/json" \
...
### Frontend URLs
- **Booking Page**: https://a6cars-frontend-zv4g.onrender.com/book.html
- **History Page**: https://a6cars-frontend-zv4g.onrender.com/history.html
- **Home Page**: https://a6cars-frontend-zv4g.onrender.com/home.html

### Backend URL
- **Base**: https://a6cars-backend-ylx7.onrender.com
- **Health**: https://a6cars-backend-ylx7.onrender.com/
