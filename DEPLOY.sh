...
echo "curl https://a6cars-backend-ylx7.onrender.com/"
echo ""
echo "Test API:"
echo "curl -X POST https://a6cars-backend-ylx7.onrender.com/api/login \\"
echo "  -H 'Content-Type: application/json' \\"
echo "  -d '{\"email\":\"john@example.com\",\"password\":\"test123\"}'"
echo ""
echo "Access Frontend:"
echo "https://a6cars-frontend-zv4g.onrender.com"
echo ""
