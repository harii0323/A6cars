...
```bash
# Register user
curl -X POST https://a6cars-backend-ylx7.onrender.com/api/register \
  -H "Content-Type: application/json" \
  -d '{"name":"Test","email":"test@example.com","phone":"9876543210","password":"test123"}'

# Login
curl -X POST https://a6cars-backend-ylx7.onrender.com/api/login \
  -H "Content-Type: application/json" \
...
| Service | URL Format |
|---------|-----------|
| Backend API | `https://a6cars-backend-ylx7.onrender.com` |
